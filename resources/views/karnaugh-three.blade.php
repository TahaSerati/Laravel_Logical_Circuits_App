...
<body>
    ...
    <div class="max-w-md mx-auto mt-8">
        <div class="bg-white shadow p-8">
            <h1 class="text-2xl font-bold mb-4 text-center">3_variables karnaugh</h1>

            @if (isset($ziro_ziro_ziro))
                <table class="table-auto border-2 hover:table-fixed border-collapse border border-slate-400 ml-15">
                    <thead>
                        <tr>
                            <th class="border p-2 border-slate-300 text-center text-bold ...">A\BC</th>
                            <th class="border p-2 border-slate-300 text-center text-bold ...">~B ~C</th>
                            <th class="border p-2 border-slate-300 text-center text-bold ..."> ~B C</th>
                            <th class="border p-2 border-slate-300 text-center text-bold ..."> B C</th>
                            <th class="border p-2 border-slate-300 text-center text-bold ..."> B ~C</th>
                        </tr>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="border border-slate-300 text-center ...">{{ $ziro_ziro_ziro }}</td>
                            <td class="border border-slate-300 text-center ...">{{ $ziro_ziro_one }}</td>
                            <td class="border border-slate-300 text-center ...">{{ $ziro_one_one }}</td>
                            <td class="border border-slate-300 text-center ...">{{ $ziro_one_ziro }}</td>
                        </tr>
                        <tr>
                            <th class="border p-2 border-slate-300 text-center text-bold ...">A</th>
                            <td class="border border-slate-300 text-center ...">{{ $one_ziro_ziro }}</td>
                            <td class="border border-slate-300 text-center ...">{{ $one_ziro_one }}</td>
                            <td class="border border-slate-300 text-center ...">{{ $one_one_one }}</td>
                            <td class="border border-slate-300 text-center ...">{{ $one_one_ziro }}</td>
                        </tr>
            ...
            @else
                <div class="mb-4">
                    ...
                    <div class="max-w-md mx-auto mt-8">
                        <div class="bg-white shadow p-8">
                            <form action="karnaugh-three" method="POST">
                                @csrf


                                <table
                                    class="table-auto border-2 hover:table-fixed border-collapse border border-slate-400 ml-15 ">
                                    <thead>
                                        <tr>
